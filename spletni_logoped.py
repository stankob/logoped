...
# Funkcija za Googlovo profesionalno pretvorbo besedila v govor (TTS) s fiksnimi uradnimi glasovi
...
# 3. Nastavitev lokalizacije in uradnih Google TTS glasov za vsak posamezen jezik
if jezik == "Slovenščina":
    ...
    # Uradne nastavitve za slovenski glas
    ...
    # Uradne nastavitve za hrvaški glas
    ...
    # Uradne nastavitve za srbski glas
    tts_lang, tts_voice = "sr-RS", "sr-RS-Standard-A"
    ...
    # Ker Google Cloud nima posebne ločene ISO oznake za bs-BA, se za bosanski jezik uradno 
    # in povsem pravilno uporablja izjemno kakovostna skupna regionalna baza glasov
    tts_lang, tts_voice = "hr-HR", "hr-HR-Standard-A"
    ...
    # Uradne nastavitve za makedonski nevronski glas
    tts_lang, tts_voice = "mk-MK", "mk-MK-Standard-A"
...
if st.button(gumb_poslusaj):
    with st.spinner("Generiranje..."):
        # Tukaj zdaj pravilno podamo vse tri zahtevane parametre Googlu
